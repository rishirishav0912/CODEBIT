                    ...
                    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-[#171717] placeholder-[#393530] text-slate-300 px-4 py-2 rounded-md focus:outline-none"
                            />
                        </div>
                        ...
                        <div className="w-full h-fit flex justify-center">
                            <button
                                type="submit"
                                className="w-[20vw] px-4 text-[#34D399] bg-[#1D332D] hover:bg-[#1b2f29]  border-2 border-[#174337] py-2 rounded-md"
                            >
                                Update Event
                            </button>
                        </div>
